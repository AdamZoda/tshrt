      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div>
          ...
          <p className="text-sm mb-6 max-w-xs">
            Premium custom clothing brand based in Morocco. Bring your designs to life with our state-of-the-art heat press technology.
          </p>
          <div className="flex gap-4">
            <a href="#" className="hover:text-[#FFD60A] transition-colors"><Instagram className="w-5 h-5" /></a>
            <a href="#" className="hover:text-[#FFD60A] transition-colors"><Twitter className="w-5 h-5" /></a>
            <a href="#" className="hover:text-[#FFD60A] transition-colors"><Facebook className="w-5 h-5" /></a>
          </div>
        </div>
